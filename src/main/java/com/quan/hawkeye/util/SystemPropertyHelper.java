...
public class SystemPropertyHelper {
    private static final SimpleLogger logger = SimpleLogger.getLogger(SystemPropertyHelper.class);
    ...
    public static long getLong(String key, long def) {
        ...
        logger.warn("Unable to parse the long system property '" + key + "': " + value + " - using the default value: " + def);
